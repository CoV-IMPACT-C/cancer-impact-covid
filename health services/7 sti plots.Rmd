...
prest <- c("Oncology Consultations", "Antigens", "Biopsy", "Neoplastic Cells" , "Pet Ct", 
            "Occult bleeding", "Sigmoidoscopy and\nColonoscopy", 
            "Cervical Biopsy", "Colposcopy", "Papanicolaou", 
            "Esophagoscopy,\nGastroduodenoscopy,\nYeyuno Ileoscopy", "Ureasa", 
            "Breast Ultrasound", "Mammography", "Breast MRI",
            "Prostate-Specific\nAntigen", "Prostate Ultrasoud")
...
g1.agg <- dat.plots.agg %>% 
  ...
  labs(y = "Count", x = "Week", fill = "Period", color = "Period", linetype = "Scenario",
       subtitle = "", title = "All Oncological Health Services") +
...
g1.a <- ggarrange(plots.g1[[1]] + ggtitle(levels(dat.plots.type$grp.cancer)[1]), 
...
ggsave(plot = g1,
       filename = "C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/paper/prestaciones fig1.pdf", 
       device = "pdf",
       dpi = "retina",
       width = 6, height = 9)
...
ggsave(plot = g1,
       filename = "C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/paper/prestaciones fig1 prevision.pdf",
       device = "pdf",
       dpi = "retina",
       width = 6, height = 18)
```
...
ggsave(plot = g1,
       filename = "C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/paper/prestaciones fig1 sexo.pdf", 
       device = "pdf",
       dpi = "retina",
       width = 6, height = 10)
```
