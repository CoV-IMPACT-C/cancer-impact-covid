...
load("C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/prestaciones/output/DB/DB para modelos agregada.RData")
...
# save(models, file = "C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/prestaciones/output/modelos/nb sti caida prestaciones/20210310 sti caida prestaciones x sexo.RData" )

# load(file = "C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/prestaciones/output/modelos/nb sti caida prestaciones/20210310 sti caida prestaciones x sexo.RData")
```
...
# save(tab.models, file = "C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/prestaciones/output/tabs_prestaciones/20210310 coef sti sexo.RData")
...
ggsave(plot = tab.plot,
       filename = "C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/prestaciones/output/plots_prestaciones/caida 2020/tab plot inter sexo adit.png", 
       device = "png",
       dpi = "retina",
       width = 10, height = 10)
```
...
# save(dat.plots, file = "C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/prestaciones/output/DB/20210310 DB predichos nb sti x sexo.RData")

# load("C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/prestaciones/output/DB/20210310 DB predichos nb sti x sexo.RData")
```
...
```{r}
ggsave(plot = g1.a,
       filename = "C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/prestaciones/output/plots_prestaciones/caida 2020/serie completa inter sexo adit.png", 
       device = "png",
       dpi = "retina",
       width = 8, height = 8)

ggsave(plot = g1.c,
       filename = "C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/prestaciones/output/plots_prestaciones/caida 2020/serie completa inter sexo sexo.png", 
       device = "png",
       dpi = "retina",
       width = 8, height = 12)
```
...
```{r}
ggsave(plot = g2.a,
       filename = "C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/prestaciones/output/plots_prestaciones/caida 2020/serie 2020 vs anterior inter sexo adit.png", 
       device = "png",
       dpi = "retina",
       width = 8, height = 8)

ggsave(plot = g2.c,
       filename = "C:/Users/sflor/Dropbox/Trabajo/ANID-Covid/Analisis IMED/prestaciones/output/plots_prestaciones/caida 2020/serie 2020 vs anterior inter sexo sexo.png", 
       device = "png",
       dpi = "retina",
       width = 12, height = 12)
```