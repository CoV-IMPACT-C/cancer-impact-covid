...
prest <- c("Oncology Consultations", "Antigens", "Biopsy", "Neoplastic Cells" , "Pet Ct", 
            ...
            "Prostate-Specific Antigen", "Prostate Ultrasound")
...
```{r LOAD DATA TABS}
load("output/tabs/coef sti datos agregados.RData")
...
write.csv2(tab1, file = "output/tabs/paper prestaciones tab1.csv")
...
write_csv2(tab2, file = "output/tabs/paper prestaciones tab2.csv")

```

## Tabla 3 

Reducción relativa de conteos durante el periodo de pandemia
...
colnames(tab3) <- c("", "Health Services Group","Absolute Reduction (CI 95%)", "Relative Reduction (CI 95%)")

write_csv2(tab3, file = "output/tabs/paper prestaciones tab3.csv")
```
...
write.csv2(tab1, file = "output/tabs/paper prestaciones tab1 sexo.csv")
...
write.csv2(tab1, file = "output/tabs/paper prestaciones tab1 prev.csv")
...
write_csv2(tab2, file = "output/tabs/paper prestaciones tab2 prestacion.csv")
...
write_csv2(tab2, file = "output/tabs/paper prestaciones tab2 prestacion y prevision.csv")
...
write_csv2(tab2, file = "output/tabs/paper prestaciones tab2 prestacion y sexo.csv")
...
write.csv2(tab.red.sex, file = "output/tabs/paper prestaciones tab3 sexo.csv", sep = ";", dec = ".")
```
...
write.csv2(tab.red.prev, file = "output/tabs/paper prestaciones tab3 prev.csv")
```
