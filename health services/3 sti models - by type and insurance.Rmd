...
save(models, file = "output/models/sti x prevision.RData" )
...
```{r}
load(file = "output/models/sti x prevision.RData")
...
save(tab.models, file = "output/tabs/coef sti prevision.RData")
```

## 2.2 Gráfico de coeficientes de modelos

```{r}
load(file = "output/tabs/coef sti prevision.RData")
```
...
ggsave(plot = tab.plot,
       filename = "output/plots/tab plot inter prev adit.png", 
       device = "png",
       dpi = "retina",
       width = 10, height = 10)
```
...
save(dat.plots, file = "output/DB/DB predichos nb sti x prevision.RData")
...
```{r}
load("output/DB/DB predichos nb sti x prevision.RData")
```
...
```{r}
ggsave(plot = g1.a,
       filename = "output/plots/serie completa inter prev adit.png", 
       device = "png",
       dpi = "retina",
       width = 8, height = 12)

ggsave(plot = g1.c,
       filename = "output/plots/serie completa inter prev prev.png", 
       device = "png",
       dpi = "retina",
       width = 8, height = 12)
```
...
```{r}
ggsave(plot = g2.a,
       filename = "output/plots/serie 2020 vs anterior inter prev adit.png", 
       device = "png",
       dpi = "retina",
       width = 8, height = 12)

ggsave(plot = g2.c,
       filename = "output/plots/serie 2020 vs anterior inter prev prev.png", 
       device = "png",
       dpi = "retina",
       width = 12, height = 12)
```