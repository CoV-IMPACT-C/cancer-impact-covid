...
dat.gast <- as.data.table(read_dta("output/DB/Cáncer gástrico (tabla con observados, predichos y contrafactual).dta"))[, cancer := "Stomach Cancer"]
...
g1.a <- ggarrange(plots.g1[[1]], 
                  plots.g1[[2]], plots.g1[[3]], plots.g1[[6]], 
...
cancer.sex <- c("Colorectal Cancer", "Stomach Cancer", "Leukemia", "Lymphoma")
